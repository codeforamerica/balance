...
class PhoneNumberProcessor
  ...
  def initialize
    ...
    phone_number_list = Twilio::REST::Client.new(ENV['AC9059ee47e7802d8fdde65e07e0b0384a'], ENV['7493f6d49f093b405c393672f0e23fd1']).account.incoming_phone_numbers.list
